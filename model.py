...
#max_pixel = 1 because normalization i believe
...
def get_model(model_name="srresnet",slices=1):
    if model_name == "srresnet":
        return get_srresnet_model(input_channel_num=slices)
    elif model_name == "unet":
        return get_unet_model(input_channel_num=slices,out_ch=slices)
    else:
